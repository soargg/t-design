...
class Checkbox extends React.PureComponent {
    ...
    render() {
        ...
        return (<TouchableOpacity style={[styles.checkbox, style]} activeOpacity={0.75} onPress={() => {
                this.toggle();
            }}>
            {isChecked ?
                <Image source={isCircle ? icon_checkbox_circle : icon_checkbox_square} style={isCircle ? styles.checkboxCircleBtn : styles.checkboxSquareBtn} resizeMode="cover"/>
                :
